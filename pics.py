...
playerleft = [pygame.transform.flip(sprites[4][3],1,0),pygame.transform.flip(sprites[3][3],1,0),pygame.transform.flip(sprites[4][3],1,0),pygame.transform.flip(sprites[5][3],1,0)]
...
rleft = [pygame.transform.flip(sprites[0][2],1,0),pygame.transform.flip(sprites[1][2],1,0),pygame.transform.flip(sprites[2][2],1,0),pygame.transform.flip(sprites[3][2],1,0),pygame.transform.flip(sprites[4][2],1,0),pygame.transform.flip(sprites[5][2],1,0),pygame.transform.flip(sprites[6][2],1,0)]
rright = [sprites[0][2],sprites[1][2],sprites[2][2],sprites[3][2],sprites[4][2],sprites[5][2],sprites[6][2]]

tdown = [sprites[7][1],sprites[6][1],sprites[7][1],sprites[8][1]]
tup = [sprites[0][1],sprites[1][1],sprites[0][1],sprites[2][1]]
tleft = [pygame.transform.flip(sprites[4][1],1,0),pygame.transform.flip(sprites[3][1],1,0),pygame.transform.flip(sprites[4][1],1,0),pygame.transform.flip(sprites[5][1],1,0)]
